...
namespace ExtraNoveListe
{
    ...
    public partial class Sweeper_Form : Form
    {
        ...
        {
            if (panel1.Controls.Count == 0) imported_list.Songs.ForEach((X) => panel1.Controls.Add(X.SongView));
            else
            {
                //panel1.
            }
        ...
        private void move_down_button1_Click(object sender, EventArgs e)
        {
        ...
        /*private void ChangePanelView(View v)
        {
            if(v == View.List)
            {
        ...
        /*public void Label2_Size(object sender, EventArgs e)
        {
            label2.Width += (def - this.Size.Width)/2;
        }*/
